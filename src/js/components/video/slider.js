...
export function updateJSlider(trip, index) {
    ...
    if (trip.narratives[index] !== "none") {
        ...
        console.log('------ left -----')
        drawLeft(dataLeft.sky, dataLeft.road, dataLeft.car, dataLeft.building);
        console.log("-------right-------")
...
function drawLeft(sky, road, car, building) {
    ...
    function drawChart() {
        ...
        var options = {
           title: 'Visual Left Outdoor Analytics'
        };
        var chart = new google.visualization.PieChart(document.getElementById('piechartleft'));
...
function drawRight(sky, road, car, building) {
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Visual Right Outdoor Analytics'
        };
        var chart = new google.visualization.PieChart(document.getElementById('piechartright'));
        chart.draw(data, options);
    }
}
